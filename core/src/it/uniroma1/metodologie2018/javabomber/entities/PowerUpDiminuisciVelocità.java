 ...
 *
 */
public class PowerUpDiminuisciVelocità extends PowerUp {
	...
	public PowerUpDiminuisciVelocità (World world, PlayScreen screen, float posizioneX, float posizioneY) {
