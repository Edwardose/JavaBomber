 ...
 *
 */
public class PowerUpDiminuisciRaggioBomba extends PowerUp{
	...
	public PowerUpDiminuisciRaggioBomba (World world, PlayScreen screen, float posizioneX, float posizioneY) {
