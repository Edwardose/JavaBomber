 ...
 *
 */
public class PowerUpAumentaRaggioBomba extends PowerUp {
	...
	public PowerUpAumentaRaggioBomba (World world, PlayScreen screen, float posizioneX, float posizioneY) {
